...
class Sarrifoshilingdahab extends StatefulWidget {
  @override
  _SarrifoshilingdahabState createState() => _SarrifoshilingdahabState();
}

class _SarrifoshilingdahabState extends State<Sarrifoshilingdahab> {
        ...
        child: SafeArea(child: Column(
          children: <Widget>[
            ...
            onPressed: (){
              ...
              launchUssd('*119*300109*$_lacagta#');
            }
            )
          ],
        ),
