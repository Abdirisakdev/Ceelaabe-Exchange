...
class Sarrifoshilingzaad extends StatefulWidget {
  @override
  _SarrifoshilingzaadState createState() => _SarrifoshilingzaadState();
}

class _SarrifoshilingzaadState extends State<Sarrifoshilingzaad> {
        ...
        child: SafeArea(child: Column(
          children: <Widget>[
            ...
            onPressed: (){
              ...
              launchUssd('*277*300109*$_lacagta#');
            }
            )
          ],
        ),
